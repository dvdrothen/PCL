...
<html lang="pt-br">
	...
	<body style="background: url(../assets/img1.jpg);
	width: 100%;
 	height: 100%;
    ...
    background-attachment:fixed;">
		<div class="container-principal" style="margin-top: 5%;" align="center">
			<header>
				<h1 class="page-header" align="center"><img src="../assets/logo.png" width="200px;"></h1>
			</header>
			<main>
				<div class="form_acesso">
					<form action="acesso.php" method="POST">
						...
						<input type="submit" name="btn_enviar" class="btn btn-primary btn-sm col-md-5" value="ENTRAR"/>
					</form>	
				</div>
				<div>
					<br>
